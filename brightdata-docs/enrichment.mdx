...
description: "Architecture and best practices for sales or marketing agent workflows that need automated data completion and lead enrichment."
---
...
3. **Discovery Layer:** Uses Bright Data’s [**SERP API**](https://brightdata.com/products/serp-api) and search for company name, urls and also rank sources by relevence and authority.
